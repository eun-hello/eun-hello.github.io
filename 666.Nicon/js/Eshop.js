...
ii.addEventListener('mouseover', function () {
    ii.src = "./img/_Eshop/_headerICON/h_util_login_on.png"
})
ii.addEventListener('mouseout', function () {
    ii.src = "./img/_Eshop/_headerICON/h_util_login.png"
})
document.querySelector('.headiion02').addEventListener('mouseover', function() {
    document.querySelector('.headiion02').src="./img/_Eshop/_headerICON/h_util_cart_on.png"
})
document.querySelector('.headiion02').addEventListener('mouseout', function() {
    document.querySelector('.headiion02').src="./img/_Eshop/_headerICON/h_util_cart.png"
})
document.querySelector('.headiion03').addEventListener('mouseover', function() {
    document.querySelector('.headiion03').src="./img/_Eshop/_headerICON/h_util_order_on.png"
})
document.querySelector('.headiion03').addEventListener('mouseout', function() {
    document.querySelector('.headiion03').src="./img/_Eshop/_headerICON/h_util_order.png"
})
document.querySelector('.headiion04').addEventListener('mouseover', function() {
    document.querySelector('.headiion04').src="./img/_Eshop/_headerICON/h_util_user_on.png"
})
document.querySelector('.headiion04').addEventListener('mouseout', function() {
    document.querySelector('.headiion04').src="./img/_Eshop/_headerICON/h_util_user.png"
})
...
free01.addEventListener('mouseover', function () {
    free01.src ="./img/_Eshop/_icon/free-icon-font-calendar-on.jpg" 
})
free01.addEventListener('mouseout', function () {
    free01.src ="./img/_Eshop/_icon/free-icon-font-calendar.png" 
})
free02.addEventListener('mouseover', function () {
    free02.src ="./img/_Eshop/_icon/free-icon-font-rocket-on.jpg" 
})
free02.addEventListener('mouseout', function () {
    free02.src ="./img/_Eshop/_icon/free-icon-font-rocket.png" 
})
free03.addEventListener('mouseover', function () {
    free03.src ="./img/_Eshop/_icon/free-icon-font-ticket-on.jpg" 
})
free03.addEventListener('mouseout', function () {
    free03.src ="./img/_Eshop/_icon/free-icon-font-ticket.png" 
})
free04.addEventListener('mouseover', function () {
    free04.src ="./img/_Eshop/_icon/free-icon-font-shopping-on.jpg" 
})
free04.addEventListener('mouseout', function () {
    free04.src ="./img/_Eshop/_icon/free-icon-font-shopping.png" 
})
free05.addEventListener('mouseover', function () {
    free05.src ="./img/_Eshop/_icon/free-icon-font-phone-on.jpg" 
})
free05.addEventListener('mouseout', function () {
    free05.src ="./img/_Eshop/_icon/free-icon-font-phone.png" 
})